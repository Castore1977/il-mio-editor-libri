...
const Editor = ({ item, onUpdate, onAddParagraph, projectData, onLinkChange, onEnterConcentrationMode }) => {
    ...
    const renderers = {
        ...
        character: () => (
             <div className="flex flex-col h-full p-8">
                <input key={`name-${item.data.id}`} type="text" defaultValue={item.data.name} onBlur={(e) => onUpdate('name', e.target.value)} placeholder="Nome Personaggio" className="text-3xl font-bold w-full bg-transparent focus:outline-none mb-2 py-10 leading-loose"/>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div
                        ...
                        className="prose dark:prose-invert max-w-none w-full focus:outline-none bg-gray-50 dark:bg-gray-800 rounded-md min-h-[96px] mb-4 p-5 leading-loose"
                    ...
                    <div
                        ...
                        className="prose dark:prose-invert max-w-none w-full focus:outline-none bg-gray-50 dark:bg-gray-800 rounded-md flex-1 min-h-[128px] p-5 leading-loose"
                        style={{ fontFamily: item.data.font, textAlign: item.data.align }}
        ...
        place: () => (
             <div className="flex flex-col h-full p-8">
                <input key={`name-${item.data.id}`} type="text" defaultValue={item.data.name} onBlur={(e) => onUpdate('name', e.target.value)} placeholder="Nome Luogo" className="text-3xl font-bold w-full bg-transparent focus:outline-none mb-4 py-10 leading-loose"/>
                <div className="flex-1 flex flex-col">
                    ...
                    <div
                        ...
                        className="prose dark:prose-invert max-w-none w-full focus:outline-none bg-gray-50 dark:bg-gray-800 rounded-md flex-1 min-h-[200px] p-5 leading-loose"
                        style={{ fontFamily: item.data.font, textAlign: item.data.align }}
